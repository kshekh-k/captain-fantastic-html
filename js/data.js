...
//     `https://places.googleapis.com/v1/places/ChIJgVkK9fkbdkgRDFwdVMx0cOg?${queryParams}`
//   );
//   if (!response.ok) {
//     return {
//       error: true,
...
// const DUMMY_GOOGLE_REVIEWS = [
//   {
//     authorName: "John Doe",
//     rating: 5,
//     text: "Amazing party! The kids had a blast!",
//     time: "2023-10-01T12:00:00Z",
//   },
//   {
//     authorName: "Jane Smith",
//     rating: 5,
//     text: "Best experience ever! Highly recommend.",
//     time: "2023-09-15T08:30:00Z",
//   },
//   {
//     authorName: "Alice Johnson",
//     rating: 5,
//     text: "Fantastic service and great fun for the kids!",
//     time: "2023-08-20T14:45:00Z",
//   },
//   {
//     authorName: "Jane Smith",
//     rating: 5,
...
//   },
// ];
// const DUMMY_GOOGLE_RATING = [
//   {
//     id: "ChIJgVkK9fkbdkgRDFwdVMx0cOg",
//     rating: 5,
//     userRatingCount: 2083,
//     reviews: [
//       {
//         authorName: "John Doe",
//         rating: 5,
...
const whychoosecf = [
  {
    ...
    description:
      "We believe that learning should be fun! Through engaging performances and interactive games, we capture children’s attention while teaching valuable life skills, inspiring confidence, and sparking creativity.",
  },
  {
    ...
    description:
      "We love making people happy! We bring positive energy and excitement to every event, ensuring unforgettable experiences for kids, parents, schools and corporate events..",
  },
  {
    ...
    description:
      "Our events are filled with imaginative characters, interactive stories, and exciting games that make every party truly one-of-a-kind.",
  },
  {
    ...
    description:
      "Planning a children’s event should be fun, not stressful. From booking to the big day, we handle every detail, so you can relax and enjoy the magic.",
  },
];
...
const whyChoose = [
  {
    title: "3,000+ Parties Delivered Every Year",
    description:
      "We’ve brought joy and laughter to thousands of children — and counting! Our experience means you’re in expert hands.",
  },
  {
    title: "2,000+ Glowing Reviews",
    description:
      "Parents, nurseries, and schools love us — and they’re not shy about saying so. Our happy customers are our biggest cheerleaders.",
  },
  {
    title: "Professionally Trained Performers",
    description:
      "Every performer is handpicked, trained, and bursting with energy — ready to turn your party into a magical memory.",
  },
  {
    title: "Fully DBS Checked",
    description:
      "Safety matters. Every team member is DBS-checked for your complete peace of mind",
  },
];
